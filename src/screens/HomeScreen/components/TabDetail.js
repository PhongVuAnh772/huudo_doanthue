        ...
        <View>
          ...
          {showButtons && (
            <View style={styles.ticket}>
              {ticketNoon ? (
                <TouchableOpacity
                  onPress={() => navigation.navigate('TicketLunch')}
                  style={{marginBottom: 10}}>
                  <Text style={{color: 'black'}}>Vé buổi trưa </Text>
                </TouchableOpacity>
              ) : (
                <View style={{marginBottom: 10}}>
                  <Text style={{color: 'gray'}}>Vé buổi trưa </Text>
                </View>
              )}

              {ticketEvening ? (
                <TouchableOpacity
                  onPress={() => navigation.navigate('TicketEvening')}
                  style={{marginBottom: 10}}>
                  <Text style={{color: 'black'}}>Vé buổi tối </Text>
                </TouchableOpacity>
              ) : (
                <View style={{marginBottom: 10}}>
                  <Text style={{color: 'gray'}}>Vé buổi tối </Text>
                </View>
              )}
              {ticketEvening && ticketNoon ? (
                <TouchableOpacity
                  onPress={() => navigation.navigate('TicketTwo')}
                  style={{marginBottom: 10}}>
                  <Text style={{color: 'black'}}>Vé 2 buổi</Text>
                </TouchableOpacity>
              ) : (
                <View style={{marginBottom: 10}}>
                  <Text style={{color: 'gray'}}>Vé 2 buổi </Text>
                </View>
              )}
            </View>
          )}
